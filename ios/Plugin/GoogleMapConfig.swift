...
public struct GoogleMapConfig: Codable {
    ...
    init(fromJSObject: JSObject) throws {
        ...
        guard let zoom = fromJSObject["zoom"] as? Double else { throw GoogleMapErrors.invalidArguments("GoogleMapConfig object is missing the required 'zoom' property") }
        
        
        guard let minZoom = fromJSObject["zoom"] as? Float else { throw GoogleMapErrors.invalidArguments("GoogleMapConfig object is missing the required 'minZoom' property") }
        
        
        guard let maxZoom = fromJSObject["zoom"] as? Float else { throw GoogleMapErrors.invalidArguments("GoogleMapConfig object is missing the required 'maxZoom' property") }
